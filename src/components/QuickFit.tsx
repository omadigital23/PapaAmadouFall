        ...
        <div className="grid grid-cols-2 gap-3 max-[760px]:grid-cols-1">
          {QUICK_FIT.map((item, index) => (
            <ScrollReveal key={item.label} delay={index * 70}>
              <article className="min-h-[164px] rounded-lg border border-line bg-surface p-5 shadow-[0_12px_42px_rgba(16,24,39,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_16px_48px_rgba(16,24,39,0.08)] max-[760px]:min-h-auto">
